	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="bs-docs-example">
				...
				$result = mysqli_query($link,"SELECT * FROM tbalumni order By nama ASC");
				...
				$sqlx = "SELECT * FROM tbalumni left join tbtahunlulus on tbalumni.id_lulus = tbtahunlulus.id_lulus order by tbalumni.nama  ASC LIMIT $awaldata , $jumlahdataperhalaman";
				...
				?>
					<tbody>
						<tr>
							...
							<td><?php echo $datax['tahun_lulus'] . "  (" .$datax['id_lulus'] . ")"?></td>
							<td><?php echo $datax['no_telp'] ?></td>
							<td><?php echo $datax['email'] ?></td>
							<td><?php echo $datax['password'] ?></td>
							<td><a class = "btn btn-info" href="index.php?hal=DataAllDetail&id_alumni=<?php echo $datax['id_alumni'] ?>">Detail</a></td>
						</tr>

...
$sql = "SELECT * tbkonfirmasi LEFT JOIN tbalumni on tbkonfirmasi.id_alumni = tbalumni.id_alumni where tbkonfirmasi.status = 'BV'";
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="bs-docs-example">
				...
				$result = mysqli_query($link,"SELECT * FROM tbkonfirmasi LEFT JOIN tbalumni on tbkonfirmasi.id_alumni = tbalumni.id_alumni where tbkonfirmasi.status = 'BV'");
				...
				$sqlx = "SELECT * FROM tbkonfirmasi left join tbalumni on tbkonfirmasi.id_alumni = tbalumni.id_alumni  where  tbkonfirmasi.status = 'BV' order by nama ASC LIMIT $awaldata , $jumlahdataperhalaman";

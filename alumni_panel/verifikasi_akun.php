	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="bs-docs-example">
				...
				$result = mysqli_query($link,"SELECT * FROM tbalumni where id_lulus = '$data[id_lulus]' and status_akun = 'Belum Aktif'");
				...
				$sqlx = "SELECT * FROM tbalumni where id_lulus = '$data[id_lulus]' and status_akun = 'Belum Aktif' order by nama ASC LIMIT $awaldata , $jumlahdataperhalaman";
